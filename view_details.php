...
<br /><br />
 ...
 <tr>
	...
	<br><br><pre>New score: <input type="text" name="<?php echo "newScore";?>"/></pre><br><br>Note: Enter 00 for new score to reset to original results.</td>
 </tr>
...
$j=1;
			while($row=mysql_fetch_array($rs))
				...
				?>
					...
					<td><?php echo $j;?></td>
					<td>
                    <div style="width: 250px;border:1px solid black;height:100px;padding:8px;overflow:auto;">
                    <?php echo $row['Question']?>
                    </div>
                    </td>
                    <td>
                    <div style="width: 175px;border:1px solid black;height:100px;padding:8px;overflow:auto;">
					...
					<td>
                    <div style="width: 300px;border:1px solid black;height:100px;padding:8px;overflow:auto;">
